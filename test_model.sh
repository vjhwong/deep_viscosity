...
export MODEL_PATH="models/whole-plasma-148/whole-plasma-148.pth"
...
python deep_viscosity/test_model_shell.py --random_seed $RANDOM_SEED --model_path $MODEL_PATH --data_path $DATA_PATH --x_dim $X_DIM --y_dim $Y_DIM --t_dim $T_DIM --batch_size $BATCH_SIZE --val_size 0.15 --test_size 0.15 --num_workers $NUM_WORKERS
