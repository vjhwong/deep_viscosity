...
def visualize_first_5_frames(data_loader):
    ...
    num_frames_to_visualize = min(10, video_frames.shape[1])  # Assuming video shape is [channels, frames, height, width]

    # Create subplots for 5 frames
    fig, axs = plt.subplots(1, num_frames_to_visualize, figsize=(20, 10))  # One row, 5 columns
